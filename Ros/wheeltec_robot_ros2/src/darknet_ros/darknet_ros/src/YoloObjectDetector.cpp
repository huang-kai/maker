...
void YoloObjectDetector::init()
{
  ...
  // image_subscriber_qos.best_effort();
  // imageSubscriber_ = it_->subscription(cameraTopicName,
  //   std::bind(&YoloObjectDetector::cameraCallback, this, _1)，rmw_qos_profile_sensor_data);
